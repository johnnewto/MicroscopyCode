...
% A ring focus is made by setting a phase distribution in the HoloEye LCD
% and by placing a (real)positive lens behind the SLM or by adding a lens phase distribution to that of the axicon phase.
...
f=1000*mm; %Focal length of the lens

Phi=179.6*deg; %Top angle of the axicon
...
F=LPLens(f,0,0,F); %Propagation through a lens (0,0 means: centered on the optical axis)
